...
namespace Albion_Direct
{
    ...
    public partial class CastSpellDescriptor : ActiveSpellDescriptor
    {
        ...
        public cw CastSpellDescriptor_Internal => _internal;
        ...
        public CastSpellDescriptor(cw instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator cw(CastSpellDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator CastSpellDescriptor(cw instance)
        {
