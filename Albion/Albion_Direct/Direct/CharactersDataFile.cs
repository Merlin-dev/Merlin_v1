...
namespace Albion_Direct
{
    ...
    public partial class CharactersDataFile : DataFile
    {
        ...
        public er CharactersDataFile_Internal => _internal;
        ...
        public CharactersDataFile(er instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator er(CharactersDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator CharactersDataFile(er instance)
        {
