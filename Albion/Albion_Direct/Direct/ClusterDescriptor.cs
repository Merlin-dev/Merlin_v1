...
namespace Albion_Direct
{
    ...
    public partial class ClusterDescriptor
    {
        ...
        public apv ClusterDescriptor_Internal => _internal;
        ...
        public ClusterDescriptor(apv instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator apv(ClusterDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ClusterDescriptor(apv instance)
        {
