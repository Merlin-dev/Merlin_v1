...
namespace Albion_Direct
{
    ...
    public partial class CompoundTileDescriptor
    {
        ...
        public ru CompoundTileDescriptor_Internal => _internal;
        ...
        public CompoundTileDescriptor(ru instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ru(CompoundTileDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator CompoundTileDescriptor(ru instance)
        {
