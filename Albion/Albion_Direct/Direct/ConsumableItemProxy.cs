...
namespace Albion_Direct
{
    ...
    public partial class ConsumableItemProxy : SimpleItemProxy
    {
        ...
        public axn ConsumableItemProxy_Internal => _internal;
        ...
        public ConsumableItemProxy(axn instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axn(ConsumableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ConsumableItemProxy(axn instance)
        {
