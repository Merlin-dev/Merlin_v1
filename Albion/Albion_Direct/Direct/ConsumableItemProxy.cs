...
namespace Albion_Direct
{
    ...
    public partial class ConsumableItemProxy : SimpleItemProxy
    {
        ...
        public ax3 ConsumableItemProxy_Internal => _internal;
        ...
        public ConsumableItemProxy(ax3 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ax3(ConsumableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ConsumableItemProxy(ax3 instance)
        {
