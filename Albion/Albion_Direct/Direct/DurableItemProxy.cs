...
namespace Albion_Direct
{
    ...
    public partial class DurableItemProxy : ItemProxy
    {
        ...
        public aw4 DurableItemProxy_Internal => _internal;
        ...
        public DurableItemProxy(aw4 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator aw4(DurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator DurableItemProxy(aw4 instance)
        {
