...
namespace Albion_Direct
{
    ...
    public partial class DurableItemProxy : ItemProxy
    {
        ...
        public axv DurableItemProxy_Internal => _internal;
        ...
        public DurableItemProxy(axv instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axv(DurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator DurableItemProxy(axv instance)
        {
