...
namespace Albion_Direct
{
    ...
    public partial class EquipmentItemProxy : DurableItemProxy
    {
        ...
        public axq EquipmentItemProxy_Internal => _internal;
        ...
        public EquipmentItemProxy(axq instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axq(EquipmentItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator EquipmentItemProxy(axq instance)
        {
