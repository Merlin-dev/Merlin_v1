...
namespace Albion_Direct
{
    ...
    public partial class EventDataContract
    {
        ...
        public kv EventDataContract_Internal => _internal;
        ...
        public EventDataContract(kv instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator kv(EventDataContract instance)
        {
            return instance._internal;
        }
        
        public static implicit operator EventDataContract(kv instance)
        {
