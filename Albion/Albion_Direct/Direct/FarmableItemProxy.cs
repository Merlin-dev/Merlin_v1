...
namespace Albion_Direct
{
    ...
    public partial class FarmableItemProxy : SimpleItemProxy
    {
        ...
        public avi FarmableItemProxy_Internal => _internal;
        ...
        public FarmableItemProxy(avi instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator avi(FarmableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FarmableItemProxy(avi instance)
        {
