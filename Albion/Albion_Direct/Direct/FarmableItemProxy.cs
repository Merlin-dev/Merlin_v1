...
namespace Albion_Direct
{
    ...
    public partial class FarmableItemProxy : SimpleItemProxy
    {
        ...
        public axm FarmableItemProxy_Internal => _internal;
        ...
        public FarmableItemProxy(axm instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axm(FarmableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FarmableItemProxy(axm instance)
        {
