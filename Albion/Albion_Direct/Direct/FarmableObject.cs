...
namespace Albion_Direct
{
    ...
    public partial class FarmableObject : BuildingObject
    {
        ...
        public a7d FarmableObject_Internal => _internal;
        ...
        public FarmableObject(a7d instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator a7d(FarmableObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FarmableObject(a7d instance)
        {
