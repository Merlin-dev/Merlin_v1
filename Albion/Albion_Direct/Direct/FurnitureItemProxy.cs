...
namespace Albion_Direct
{
    ...
    public partial class FurnitureItemProxy : DurableItemProxy
    {
        ...
        public axu FurnitureItemProxy_Internal => _internal;
        ...
        public FurnitureItemProxy(axu instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axu(FurnitureItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FurnitureItemProxy(axu instance)
        {
