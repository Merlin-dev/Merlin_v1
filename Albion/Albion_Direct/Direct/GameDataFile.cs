...
namespace Albion_Direct
{
    ...
    public partial class GameDataFile : DataFile
    {
        ...
        public aie GameDataFile_Internal => _internal;
        ...
        public GameDataFile(aie instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator aie(GameDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator GameDataFile(aie instance)
        {
