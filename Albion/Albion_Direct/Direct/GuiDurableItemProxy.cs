...
namespace Albion_Direct
{
    ...
    public partial class GuiDurableItemProxy : GuiItemProxy
    {
        ...
        private bcb _internal;
        
        #region Properties
        
        public bcb GuiDurableItemProxy_Internal => _internal;
        ...
        public GuiDurableItemProxy(bcb instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator bcb(GuiDurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator GuiDurableItemProxy(bcb instance)
        {
