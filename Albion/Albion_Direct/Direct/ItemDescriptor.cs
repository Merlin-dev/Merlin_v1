...
namespace Albion_Direct
{
    ...
    public partial class ItemDescriptor
    {
        ...
        public cs ItemDescriptor_Internal => _internal;
        ...
        public ItemDescriptor(cs instance)
        {
            _internal = instance;
        }
        ...
        {
            _propertyReflectionPool.Add(typeof(cs).GetProperty("aq", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance));
            _propertyReflectionPool.Add(typeof(cs).GetProperty("ap", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance));
        }
        ...
        public static implicit operator cs(ItemDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ItemDescriptor(cs instance)
        {
