...
namespace Albion_Direct
{
    ...
    public partial class ItemDescriptor
    {
        ...
        public c1 ItemDescriptor_Internal => _internal;
        ...
        public ItemDescriptor(c1 instance)
        {
            _internal = instance;
        }
        ...
        {
            _propertyReflectionPool.Add(typeof(c1).GetProperty("aq", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance));
            _propertyReflectionPool.Add(typeof(c1).GetProperty("ap", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance));
        }
        ...
        public static implicit operator c1(ItemDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ItemDescriptor(c1 instance)
        {
