...
namespace Albion_Direct
{
    ...
    public partial class ItemsDataFile : DataFile
    {
        ...
        public ahz ItemsDataFile_Internal => _internal;
        ...
        public ItemsDataFile(ahz instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ahz(ItemsDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ItemsDataFile(ahz instance)
        {
