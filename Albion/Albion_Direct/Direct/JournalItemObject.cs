...
namespace Albion_Direct
{
    ...
    public partial class JournalItemObject : DurableItemObject
    {
        ...
        public axq JournalItemObject_Internal => _internal;
        ...
        public JournalItemObject(axq instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axq(JournalItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator JournalItemObject(axq instance)
        {
