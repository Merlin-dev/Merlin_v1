...
namespace Albion_Direct
{
    ...
    public partial class LocalPlayerAttributes : FightingAttributes
    {
        ...
        public agw LocalPlayerAttributes_Internal => _internal;
        ...
        public LocalPlayerAttributes(agw instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator agw(LocalPlayerAttributes instance)
        {
            return instance._internal;
        }
        
        public static implicit operator LocalPlayerAttributes(agw instance)
        {
