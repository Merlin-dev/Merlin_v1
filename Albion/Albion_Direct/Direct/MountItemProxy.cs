...
namespace Albion_Direct
{
    ...
    public partial class MountItemProxy : EquipmentItemProxy
    {
        ...
        public axx MountItemProxy_Internal => _internal;
        ...
        public MountItemProxy(axx instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axx(MountItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator MountItemProxy(axx instance)
        {
