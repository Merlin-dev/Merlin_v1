...
namespace Albion_Direct
{
    ...
    public partial class MovingObject : WorldObject
    {
        ...
        public ays MovingObject_Internal => _internal;
        ...
        public MovingObject(ays instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ays(MovingObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator MovingObject(ays instance)
        {
