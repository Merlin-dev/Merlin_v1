...
namespace Albion_Direct
{
    ...
    public partial class OperationResponseDataContract
    {
        ...
        public ns OperationResponseDataContract_Internal => _internal;
        ...
        public OperationResponseDataContract(ns instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ns(OperationResponseDataContract instance)
        {
            return instance._internal;
        }
        
        public static implicit operator OperationResponseDataContract(ns instance)
        {
