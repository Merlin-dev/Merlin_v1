...
namespace Albion_Direct
{
    ...
    public partial class PassiveSpellDescriptor : SpellDescriptor
    {
        ...
        public ahh PassiveSpellDescriptor_Internal => _internal;
        ...
        public PassiveSpellDescriptor(ahh instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ahh(PassiveSpellDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator PassiveSpellDescriptor(ahh instance)
        {
