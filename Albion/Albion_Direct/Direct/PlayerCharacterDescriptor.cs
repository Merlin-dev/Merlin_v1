...
namespace Albion_Direct
{
    ...
    public partial class PlayerCharacterDescriptor : CharacterDescriptor
    {
        ...
        private ait _internal;
        
        #region Properties
        
        public ait PlayerCharacterDescriptor_Internal => _internal;
        ...
        public PlayerCharacterDescriptor(ait instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ait(PlayerCharacterDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator PlayerCharacterDescriptor(ait instance)
        {
