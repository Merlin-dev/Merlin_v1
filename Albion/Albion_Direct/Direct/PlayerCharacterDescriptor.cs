...
namespace Albion_Direct
{
    ...
    public partial class PlayerCharacterDescriptor : CharacterDescriptor
    {
        ...
        public aim PlayerCharacterDescriptor_Internal => _internal;
        ...
        public PlayerCharacterDescriptor(aim instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator aim(PlayerCharacterDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator PlayerCharacterDescriptor(aim instance)
        {
