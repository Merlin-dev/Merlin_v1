...
namespace Albion_Direct
{
    ...
    public partial class SilverObject : StaticObject
    {
        ...
        public a7d SilverObject_Internal => _internal;
        ...
        public SilverObject(a7d instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator a7d(SilverObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SilverObject(a7d instance)
        {
