...
namespace Albion_Direct
{
    ...
    public partial class SilverObject : StaticObject
    {
        ...
        public a7o SilverObject_Internal => _internal;
        ...
        public SilverObject(a7o instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator a7o(SilverObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SilverObject(a7o instance)
        {
