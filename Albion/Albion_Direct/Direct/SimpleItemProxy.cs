...
namespace Albion_Direct
{
    ...
    public partial class SimpleItemProxy : ItemProxy
    {
        ...
        public ax1 SimpleItemProxy_Internal => _internal;
        ...
        public SimpleItemProxy(ax1 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ax1(SimpleItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SimpleItemProxy(ax1 instance)
        {
