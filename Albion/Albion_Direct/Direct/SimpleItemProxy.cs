...
namespace Albion_Direct
{
    ...
    public partial class SimpleItemProxy : ItemProxy
    {
        ...
        public axl SimpleItemProxy_Internal => _internal;
        ...
        public SimpleItemProxy(axl instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator axl(SimpleItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SimpleItemProxy(axl instance)
        {
