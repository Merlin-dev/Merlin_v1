...
{
    /* Internal type: cx.SpellCategory */
    ...
    {
        public static cx.SpellCategory ToInternal(this SpellCategory instance)
        {
            return (cx.SpellCategory)instance;
        }
        
        public static SpellCategory ToWrapped(this cx.SpellCategory instance)
        {
