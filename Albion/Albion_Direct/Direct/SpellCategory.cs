...
{
    /* Internal type: co.SpellCategory */
    ...
    {
        public static co.SpellCategory ToInternal(this SpellCategory instance)
        {
            return (co.SpellCategory)instance;
        }
        
        public static SpellCategory ToWrapped(this co.SpellCategory instance)
        {
