...
namespace Albion_Direct
{
    ...
    public partial class SpellDescriptor
    {
        ...
        private cj _internal;
        
        #region Properties
        
        public cj SpellDescriptor_Internal => _internal;
        ...
        public SpellDescriptor(cj instance)
        {
            _internal = instance;
        }
        ...
        {
            _methodReflectionPool.Add(typeof(cj).GetMethod("jb", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{}, null));
        }
        ...
        public static implicit operator cj(SpellDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SpellDescriptor(cj instance)
        {
