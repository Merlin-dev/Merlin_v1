...
namespace Albion_Direct
{
    ...
    public partial class SpellDescriptor
    {
        ...
        public string GetIdent() => _internal.kt();
        public string GetName() => _internal.ku();
        ...
        {
            _methodReflectionPool.Add(typeof(b5).GetMethod("iz", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{}, null));
        }
