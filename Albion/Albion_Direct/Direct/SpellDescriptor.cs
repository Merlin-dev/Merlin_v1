...
namespace Albion_Direct
{
    ...
    public partial class SpellDescriptor
    {
        ...
        public cn SpellDescriptor_Internal => _internal;
        ...
        public SpellDescriptor(cn instance)
        {
            _internal = instance;
        }
        ...
        {
            _methodReflectionPool.Add(typeof(cn).GetMethod("jb", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{}, null));
        }
        ...
        public static implicit operator cn(SpellDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator SpellDescriptor(cn instance)
        {
