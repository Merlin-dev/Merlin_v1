...
namespace Albion_Direct
{
    ...
    public partial class TemplateXmlOperator
    {
        ...
        public ko TemplateXmlOperator_Internal => _internal;
        ...
        public TemplateXmlOperator(ko instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ko(TemplateXmlOperator instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TemplateXmlOperator(ko instance)
        {
