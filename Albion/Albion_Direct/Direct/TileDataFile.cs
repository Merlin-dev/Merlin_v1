...
namespace Albion_Direct
{
    ...
    public partial class TileDataFile
    {
        ...
        private r8 _internal;
        
        #region Properties
        
        public r8 TileDataFile_Internal => _internal;
        ...
        public TileDataFile(r8 instance)
        {
            _internal = instance;
        }
        ...
        static TileDataFile()
        {
            _methodReflectionPool.Add(typeof(r8).GetMethod("d", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
            _methodReflectionPool.Add(typeof(r8).GetMethod("f", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
        }
        ...
        public static implicit operator r8(TileDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TileDataFile(r8 instance)
        {
