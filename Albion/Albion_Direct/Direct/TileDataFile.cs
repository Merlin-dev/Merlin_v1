...
namespace Albion_Direct
{
    ...
    public partial class TileDataFile
    {
        ...
        private rl _internal;
        
        #region Properties
        
        public rl TileDataFile_Internal => _internal;
        ...
        public TileDataFile(rl instance)
        {
            _internal = instance;
        }
        ...
        static TileDataFile()
        {
            _methodReflectionPool.Add(typeof(rl).GetMethod("d", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
            _methodReflectionPool.Add(typeof(rl).GetMethod("f", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
        }
        ...
        public static implicit operator rl(TileDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TileDataFile(rl instance)
        {
