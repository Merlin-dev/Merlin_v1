...
namespace Albion_Direct
{
    ...
    public partial class TileDataFile
    {
        ...
        private sf _internal;
        
        #region Properties
        
        public sf TileDataFile_Internal => _internal;
        ...
        public TileDataFile(sf instance)
        {
            _internal = instance;
        }
        ...
        static TileDataFile()
        {
            _methodReflectionPool.Add(typeof(sf).GetMethod("d", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
            _methodReflectionPool.Add(typeof(sf).GetMethod("f", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
        }
        ...
        public static implicit operator sf(TileDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TileDataFile(sf instance)
        {
