...
namespace Merlin.API.Direct
{
    ...
    public partial class AgentDescriptor
    {
        ...
        public ald AgentDescriptor_Internal => _internal;
        ...
        public AgentDescriptor(ald instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ald(AgentDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator AgentDescriptor(ald instance)
        {
