...
namespace Merlin.API.Direct
{
    ...
    public partial class CastSpellEventHandler
    {
        ...
        public au7 CastSpellEventHandler_Internal => _internal;
        ...
        public CastSpellEventHandler(au7 instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator au7(CastSpellEventHandler instance)
        {
            return instance._internal;
        }
        
        public static implicit operator CastSpellEventHandler(au7 instance)
        {
