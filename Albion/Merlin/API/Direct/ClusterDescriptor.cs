...
namespace Merlin.API.Direct
{
    ...
    public partial class ClusterDescriptor
    {
        ...
        public alm ClusterDescriptor_Internal => _internal;
        ...
        public ClusterDescriptor(alm instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator alm(ClusterDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ClusterDescriptor(alm instance)
        {
