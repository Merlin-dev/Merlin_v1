...
namespace Merlin.API.Direct
{
    ...
    public partial class CompoundTileDescriptor
    {
        ...
        public nk CompoundTileDescriptor_Internal => _internal;
        ...
        public CompoundTileDescriptor(nk instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator nk(CompoundTileDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator CompoundTileDescriptor(nk instance)
        {
