...
namespace Merlin.API.Direct
{
    ...
    public partial class ConsumableItemObject : SimpleItemObject
    {
        ...
        public as6 ConsumableItemObject_Internal => _internal;
        ...
        public ConsumableItemObject(as6 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator as6(ConsumableItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ConsumableItemObject(as6 instance)
        {
