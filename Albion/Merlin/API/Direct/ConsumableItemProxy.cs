...
namespace Merlin.API.Direct
{
    ...
    public partial class ConsumableItemProxy : SimpleItemProxy
    {
        ...
        public ar0 ConsumableItemProxy_Internal => _internal;
        ...
        public ConsumableItemProxy(ar0 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ar0(ConsumableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ConsumableItemProxy(ar0 instance)
        {
