...
namespace Merlin.API.Direct
{
    ...
    public partial class DurableItemObject : ItemObject
    {
        ...
        public atb DurableItemObject_Internal => _internal;
        ...
        public DurableItemObject(atb instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atb(DurableItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator DurableItemObject(atb instance)
        {
