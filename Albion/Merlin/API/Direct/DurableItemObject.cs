...
namespace Merlin.API.Direct
{
    ...
    public partial class DurableItemObject : ItemObject
    {
        ...
        public arv DurableItemObject_Internal => _internal;
        ...
        public DurableItemObject(arv instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator arv(DurableItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator DurableItemObject(arv instance)
        {
