...
namespace Merlin.API.Direct
{
    ...
    public partial class DurableItemProxy : ItemProxy
    {
        ...
        public ars DurableItemProxy_Internal => _internal;
        ...
        public DurableItemProxy(ars instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ars(DurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator DurableItemProxy(ars instance)
        {
