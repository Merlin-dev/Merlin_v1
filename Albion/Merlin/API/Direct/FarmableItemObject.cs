...
namespace Merlin.API.Direct
{
    ...
    public partial class FarmableItemObject : SimpleItemObject
    {
        ...
        public atk FarmableItemObject_Internal => _internal;
        ...
        public FarmableItemObject(atk instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atk(FarmableItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FarmableItemObject(atk instance)
        {
