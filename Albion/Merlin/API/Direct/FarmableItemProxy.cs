...
namespace Merlin.API.Direct
{
    ...
    public partial class FarmableItemProxy : SimpleItemProxy
    {
        ...
        public atf FarmableItemProxy_Internal => _internal;
        ...
        public FarmableItemProxy(atf instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atf(FarmableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FarmableItemProxy(atf instance)
        {
