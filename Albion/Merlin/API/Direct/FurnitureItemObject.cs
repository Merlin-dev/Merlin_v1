...
namespace Merlin.API.Direct
{
    ...
    public partial class FurnitureItemObject : DurableItemObject
    {
        ...
        public atp FurnitureItemObject_Internal => _internal;
        ...
        public FurnitureItemObject(atp instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atp(FurnitureItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FurnitureItemObject(atp instance)
        {
