...
namespace Merlin.API.Direct
{
    ...
    public partial class FurnitureItemProxy : DurableItemProxy
    {
        ...
        public atd FurnitureItemProxy_Internal => _internal;
        ...
        public FurnitureItemProxy(atd instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atd(FurnitureItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FurnitureItemProxy(atd instance)
        {
