...
namespace Merlin.API.Direct
{
    ...
    public partial class FurnitureItemProxy : DurableItemProxy
    {
        ...
        public arx FurnitureItemProxy_Internal => _internal;
        ...
        public FurnitureItemProxy(arx instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator arx(FurnitureItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator FurnitureItemProxy(arx instance)
        {
