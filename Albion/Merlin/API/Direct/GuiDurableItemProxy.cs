...
namespace Merlin.API.Direct
{
    ...
    public partial class GuiDurableItemProxy : GuiItemProxy
    {
        ...
        public a4d GuiDurableItemProxy_Internal => _internal;
        ...
        public GuiDurableItemProxy(a4d instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator a4d(GuiDurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator GuiDurableItemProxy(a4d instance)
        {
