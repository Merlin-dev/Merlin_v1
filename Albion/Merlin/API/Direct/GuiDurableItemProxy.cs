...
namespace Merlin.API.Direct
{
    ...
    public partial class GuiDurableItemProxy : GuiItemProxy
    {
        ...
        public a39 GuiDurableItemProxy_Internal => _internal;
        ...
        public GuiDurableItemProxy(a39 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator a39(GuiDurableItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator GuiDurableItemProxy(a39 instance)
        {
