...
namespace Merlin.API.Direct
{
    ...
    public partial class ItemsDataFile : DataFile
    {
        ...
        public aea ItemsDataFile_Internal => _internal;
        ...
        public ItemsDataFile(aea instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator aea(ItemsDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator ItemsDataFile(aea instance)
        {
