...
namespace Merlin.API.Direct
{
    ...
    public partial class JournalItemObject : DurableItemObject
    {
        ...
        public ar3 JournalItemObject_Internal => _internal;
        ...
        public JournalItemObject(ar3 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ar3(JournalItemObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator JournalItemObject(ar3 instance)
        {
