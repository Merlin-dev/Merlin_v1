...
namespace Merlin.API.Direct
{
    ...
    public partial class JournalItemProxy : DurableItemProxy
    {
        ...
        public ar1 JournalItemProxy_Internal => _internal;
        ...
        public JournalItemProxy(ar1 instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator ar1(JournalItemProxy instance)
        {
            return instance._internal;
        }
        
        public static implicit operator JournalItemProxy(ar1 instance)
        {
