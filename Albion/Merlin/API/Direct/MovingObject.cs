...
namespace Merlin.API.Direct
{
    ...
    public partial class MovingObject : WorldObject
    {
        ...
        public atw MovingObject_Internal => _internal;
        ...
        public MovingObject(atw instance) : base(instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator atw(MovingObject instance)
        {
            return instance._internal;
        }
        
        public static implicit operator MovingObject(atw instance)
        {
