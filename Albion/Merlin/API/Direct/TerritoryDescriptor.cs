...
namespace Merlin.API.Direct
{
    ...
    public partial class TerritoryDescriptor
    {
        ...
        private alr _internal;
        
        #region Properties
        
        public alr TerritoryDescriptor_Internal => _internal;
        ...
        public TerritoryDescriptor(alr instance)
        {
            _internal = instance;
        }
        ...
        public static implicit operator alr(TerritoryDescriptor instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TerritoryDescriptor(alr instance)
        {
