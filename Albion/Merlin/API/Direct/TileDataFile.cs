...
namespace Merlin.API.Direct
{
    ...
    public partial class TileDataFile
    {
        ...
        private ny _internal;
        
        #region Properties
        
        public ny TileDataFile_Internal => _internal;
        ...
        public TileDataFile(ny instance)
        {
            _internal = instance;
        }
        ...
        static TileDataFile()
        {
            _methodReflectionPool.Add(typeof(ny).GetMethod("b", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
            _methodReflectionPool.Add(typeof(ny).GetMethod("d", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance, null, new Type[]{typeof(System.Xml.XmlReader)}, null));
        }
        ...
        public static implicit operator ny(TileDataFile instance)
        {
            return instance._internal;
        }
        
        public static implicit operator TileDataFile(ny instance)
        {
