...
namespace Merlin.API.Direct
{
    ...
    public partial class Utilities
    {
        ...
        public static GuiItemProxy GetStackProxy(ItemProxy A_0) => a4x.a((aro)A_0);
        public static int SomeCalculationWithUnfloatyFloats(Number A_0, Number A_1) => a4x.b((mv)A_0, (mv)A_1);
